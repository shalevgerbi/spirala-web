...
import styles from "./StickyIcons.module.css";
...
export default function StickyIcons() {
  ...
  const handleWhatsApp = () => {
    window.open("https://wa.me/+972522215609", "_blank");
  };

  const handleInstagram = () => {
    window.open("https://www.instagram.com/spirala_bysapir/", "_blank");
  };
